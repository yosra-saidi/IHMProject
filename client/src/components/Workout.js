  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      <div className="bg-purple-100 p-4 rounded-lg mt-6 text-center">
        ...
        <p className="text-sm text-gray-500">Don’t stop when you’re tired. Stop when you’re done</p>
        <button className="mt-4 bg-purple-700 text-white px-4 py-2 rounded-full">Upgrade</button>
      </div>
    </div>
  );
}
